...
- 기본 분석 (base analysis): `yc_companies_report.md`, `yc_student_founders_report.md`, `yc_application_strategy.md`, `yc_report_ai_b2b.md`, `yc_report_asia.md`, `yc_founders_career_analysis.md`.

...
| **상세** | `yc_companies_all_overview.md` 참고 |
...
| **상세** | `yc_founders_w25_overview.md` 참고 |
...
| **상세** | `yc_founders_s24_w24_overview.md` 참고 |
...
| 순서 | 파일 | 내용 |
|------|------|------|
| 1 | `yc_companies_report.md` | YC 전체 기업 경향성 (연도별, 산업별, AI 비율 등) |
| 2 | `yc_recent_batches_raw.md` | 최근 3개 배치 (W24, S24, W25) 기업 리스트 |

### 2단계: 창업자 분석
| 순서 | 파일 | 내용 |
|------|------|------|
| 3 | `yc_student_founders_report.md` | 학부생/중퇴 창업팀 93개 기업 분석 |
| 4 | `yc_application_strategy.md` | 비전통적 배경으로 YC 합격한 패턴 분석 |

### 3단계: 방향 설정
| 순서 | 파일 | 내용 |
|------|------|------|
| 5 | `yc_report_ai_b2b.md` | AI+B2B 방향 — 270개 기업 분석, 8개 세부 카테고리 |
| 6 | `yc_report_asia.md` | 한국/아시아 방향 — 139개 기업, 13명 한국인 창업자 |
